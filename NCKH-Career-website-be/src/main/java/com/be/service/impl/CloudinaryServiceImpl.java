...
public class CloudinaryServiceImpl implements CloudinaryService {
	public static final String CLOUDINARY_CLOUD_NAME = "dwezyh13q";
	public static final String CLOUDINARY_API_KEY = "752448914721555";
	public static final String CLOUDINARY_API_SECRET = "w2OvRdRksoaFOl8UTwylf3YqtYc";
